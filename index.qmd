...
→ SQLやRやSASを書かずに、[チャットでお話ししながら分析したい]{.bg style="--col:#f4e04d"}
...
今回は VSCode 上の GitHub Copilot を使って実装しました。  
GitHub Copilot、本当に便利です。
...
:::{.column width="50%"}
### Copilotを使った開発
- [自然言語で指示]{.bg style="--col:#f4e04d"}
- AIが実装
- [対話的に修正]{.bg style="--col:#f4e04d"}
- 完成！
:::
::::
